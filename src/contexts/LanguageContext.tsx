...
const translations = {
  de: {
    ...
    // Main page
    'main.title': '🤖 KI News Digest',
    'main.subtitle': 'Automatische KI- und Tech-News Aggregation mit intelligenter Zusammenfassung für studentenfreundliche Newsletter',
    'main.student_news': 'Top 10 für Studenten anzeigen',
    'main.database': 'KI-News Datenbank durchsuchen',
    'main.refresh': 'News aktualisieren',
    'main.generate_digest': 'Wöchentlichen Digest generieren',
    'main.week': 'KW',
    'main.automatically_updated': 'Automatisch aktualisiert',
    'main.add_article': 'Artikel hinzufügen',
    'main.custom_articles': 'eigene Artikel in der Übersicht',
    'main.no_custom_articles': 'Noch keine eigenen Artikel',
    'main.click_plus_add': 'Klicken Sie auf das + um Artikel hinzuzufügen',
    'main.custom_article_label': 'Eigener Artikel',
    'main.articles_added': 'Artikel hinzugefügt',
    'main.no_news_found': 'Keine Nachrichten für diese Woche gefunden',
    ...
    // Student News
    'student.title': 'Top 10 für Studenten',
    'student.subtitle': 'Die relevantesten Tech- und KI-Nachrichten für Studierende - kuratiert und nach Wichtigkeit sortiert',
    'student.back': 'Zurück zur Hauptseite',
    ...
    'student.no_articles_desc': 'Momentan sind keine Artikel verfügbar, die unseren Kriterien entsprechen.',
    'student.selection_criteria': 'Auswahlkriterien',
    'student.relevance_filter': 'Relevanz-Filter:',
    'student.ai_tech_topics': '• KI & Technologie-Themen',
    'student.programming_software': '• Programmierung & Software',
    'student.career_education': '• Karriere & Bildung',
    'student.startup_innovation': '• Startup & Innovation',
    'student.evaluation_criteria': 'Bewertungskriterien:',
    'student.news_timeliness': '• Aktualität der Nachrichten',
    'student.student_keywords': '• Studenten-relevante Keywords',
    'student.trusted_sources': '• Vertrauenswürdige Quellen',
    'student.practical_application': '• Praktische Anwendbarkeit',
    ...
    'newsletter.email_description': 'Wir verwenden Ihre E-Mail-Adresse nur für den Versand des Newsletters.',
    'newsletter.email_invalid': 'Bitte geben Sie eine gültige E-Mail-Adresse ein.',
    'newsletter.subscription_successful': 'Anmeldung erfolgreich!',
    'newsletter.check_email': 'Bitte bestätigen Sie Ihre E-Mail-Adresse über den Link, den wir Ihnen gesendet haben.',
    'newsletter.subscription_error': 'Es ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.',
    'newsletter.thank_you': 'Vielen Dank für Ihr Interesse! Sie erhalten bald eine Bestätigungs-E-Mail.',
    'newsletter.already_registered': 'Diese E-Mail ist bereits registriert. Vielen Dank für Ihr Interesse!',
    ...
    'newsletter.unsubscribe_info': 'Sie können sich jederzeit vom Newsletter abmelden.',
    ...
    'management.back_to_subscribe': 'Zurück zum Abonnieren',
    ...
    'management.confirmed_subscribers': 'bestätigte Abonnenten',
    'management.click_load': 'Klicken Sie auf \'Laden\'',
    'management.load': 'Laden',
    'management.loading': 'Lädt...',
    'management.send_time': 'Versandzeitpunkt',
    'management.select_newsletter': 'Bitte wählen Sie einen Newsletter-Inhalt aus dem Archiv aus.',
    ...
    'management.selected_content': 'Ausgewählter Newsletter-Inhalt',
    'management.content_placeholder': 'Newsletter-Inhalt wird hier angezeigt...',
    'management.generate_preview': 'Vorschau generieren',
    'management.select_and_preview': 'Bitte wählen Sie einen Newsletter aus und klicken Sie auf \'Vorschau generieren\'.',
    ...
    'archive.footer_title': 'KI News Digest - Newsletter-Archiv Q&A System für Studierende',
    ...
    'database.select_cluster': 'Cluster auswählen',
    'database.date_newest': 'Datum (Neueste zuerst)',
    'database.date_oldest': 'Datum (Älteste zuerst)',
    ...
    'database.clear_filters': 'Filter zurücksetzen',
    ...
    'database.list': 'Liste',
    'database.no_articles': 'Noch keine Artikel verfügbar',
    'database.no_articles_desc': 'Lade zuerst einige Artikel über die Hauptseite oder verwende den RSS Debug Test.',
    ...
    'news.no_articles_available': 'Keine Artikel verfügbar',
    ...
    'news.removed_from_overview': 'Artikel aus der Übersicht entfernt',
    
    // Weekly Digest
    'digest.top_10': 'Top 10',
    'digest.all_articles': 'Alle Artikel',
    'digest.selected_articles': 'ausgewählte Artikel für Newsletter',
    'digest.automatically_selected': 'relevanteste Artikel (automatisch ausgewählt)',
    'digest.selected': 'ausgewählt',
    'digest.week_overview': 'Wochenübersicht:',
    'digest.weeks_available': 'Wochen verfügbar',
    'digest.news_tab': 'Nachrichten',
    'digest.newsletter_tab': 'Newsletter',
    'digest.questions_tab': 'Fragen',
    'digest.selected_short': 'ausgewählt',
    'digest.create_newsletter': 'Newsletter erstellen',
    'digest.regenerate': 'Neu generieren',
    'digest.generating': 'Generiert...',
    
    // Article Selection
    'selection.select_articles': 'Artikel für Newsletter auswählen',
    'selection.articles_selected': 'von',
    'selection.articles_selected_total': 'Artikeln ausgewählt',
    'selection.reset_selection': 'Auswahl zurücksetzen',
    ...
    'selection.open_article': 'Artikel öffnen',
    'selection.cancel': 'Abbrechen',
    'selection.use_articles': 'Artikel verwenden',
    'selection.confirm': 'Bestätigen',
    'selection.select_top_10': 'Top 10 auswählen',
    'selection.delete_permanently': 'Artikel dauerhaft löschen',
    'selection.select_newsletter_articles': 'Newsletter-Artikel auswählen',
    ...
    'database.avg_relevance': 'Ø Relevanz:',
    ...
    'loading.creating_overview': 'Erstelle Wochenübersicht...',
    ...
    'qa.smart_suggestions': 'Intelligente Fragevorschläge:',
    'qa.articles_available': 'Artikel verfügbar',
    'qa.newsletter_content_available': 'Newsletter-Inhalt verfügbar',
    ...
    'qa.current_suggestions': 'Aktuelle Fragevorschläge:',
    'qa.loading_suggestions': 'Lade aktuelle Fragevorschläge...',
    ...
    'qa.no_current_articles': 'Keine aktuellen Artikel verfügbar - verwende Standard-Fragen',
    ...
    'toast.article_added_successfully': 'Artikel erfolgreich hinzugefügt und gespeichert',
    ...
    'toast.articles_for_summary': 'Artikel für die Zusammenfassung ausgewählt',
    ...
    'toast.newsservice_unavailable': 'NewsService nicht verfügbar',
    ...
    'voice.microphone_access_denied': 'Mikrofonzugriff verweigert oder nicht verfügbar.',
    ...
    'rss.manage_sources': 'RSS-Quellen verwalten und neue hinzufügen',
    'rss.no_sources': 'Keine RSS-Quellen vorhanden. Fügen Sie eine hinzu.',
    'custom.add_article': 'Eigenen Artikel hinzufügen',
    'custom.add_article_button': 'Artikel hinzufügen',
  ...
  en: {
    ...
    // Main page
    'main.title': '🤖 AI News Digest',
    'main.subtitle': 'Automatic AI and Tech News Aggregation with intelligent summarization for student-friendly newsletters',
    ...
    'student.ai_tech_topics': '• AI & Technology Topics',
    'student.programming_software': '• Programming & Software',
    'student.career_education': '• Career & Education',
    'student.startup_innovation': '• Startup & Innovation',
    'student.evaluation_criteria': 'Evaluation Criteria:',
    'student.news_timeliness': '• News Timeliness',
    'student.student_keywords': '• Student-relevant Keywords',
    'student.trusted_sources': '• Trusted Sources',
    'student.practical_application': '• Practical Application',
